...
contextBridge.exposeInMainWorld('dsh', {
  ...
  musicResolve: (link) => ipcRenderer.invoke('music:resolve', link),
  musicList: () => ipcRenderer.invoke('music:list'),
  musicSave: (list) => ipcRenderer.invoke('music:save', list),
  musicConfigGet: () => ipcRenderer.invoke('music:config-get'),
  musicConfigSet: (cfg) => ipcRenderer.invoke('music:config-set', cfg),
